...
fechaColor.value = [{ color: '#595d65' }, { color: '#595d65' },  { color: '#595d65' }]
...
const educacion = ref([
  ...
  {
    fecha: '2023',
    title: 'Diseño de la experiencia de usuario (UX)',
    descripcion:
      'Incumbencias Profesionales: Diseño de experiencias de usuario, desarrollo de interfaces intuitivas, creación de prototipos y pruebas de usabilidad para optimizar la interacción en productos digitales.',
    sitio: 'Coursera - Google',
  },
  {
    fecha: '2022',
    title: 'Desarrollo Front End React',
    descripcion:
      'Incumbencias Profesionales: Desarrollo de interfaces interactivas y dinámicas utilizando React, optimización del rendimiento en aplicaciones web y creación de componentes reutilizables para mejorar la experiencia de usuario.',
    sitio: 'Education IT',
  },
])
</script>
